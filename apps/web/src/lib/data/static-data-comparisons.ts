...
// =============================================================================
// EXPANSION BATCH 14 — pairs leveraging 3rd nbhds in 2-nbhd cities
// =============================================================================
COMPARISONS.push(
  // BERGEN
  {
    slug: "bryggen-vs-fjellsiden",
    citySlug: "bergen", countrySlug: "norway",
    aSlug: "bryggen-area", bSlug: "bergenhus-fjellsiden",
    aLabel: "Bryggen", bLabel: "Fjellsiden",
    metaTitle: "Bryggen vs Fjellsiden: Where to Stay in Bergen",
    metaDescription: "Bergen's UNESCO wharf or hillside Fjellsiden? Real take on atmosphere, mobility and price.",
    intro: "Bryggen is the iconic UNESCO wharf — colored gable houses on the harbor. Fjellsiden is the hillside east — wooden-house residential, Fløibanen funicular base. Walkable to each other in 5-10 min.",
    rounds: [
      { question: "Atmosphere", winner: "a", body: "Bryggen wins by definition — the iconic photo. Fjellsiden is residential calm." },
      { question: "Funicular access", winner: "b", body: "Fjellsiden is at the Fløibanen base. Bryggen is 5 min walk." },
      { question: "Mobility", winner: "a", body: "Bryggen is flat. Fjellsiden is steep wooden-house streets." },
      { question: "Quiet sleep", winner: "b", body: "Fjellsiden residential past 10pm. Bryggen has cruise-tourist noise during day." },
      { question: "Price", winner: "b", body: "Fjellsiden 15-20% cheaper than Bryggen for equivalent product." },
    ],
    pickA: "Pick Bryggen for first-time visits, photo-focused trips, sights-at-door priority.",
    pickB: "Pick Fjellsiden for repeat visits, light sleepers, longer stays.",
    bottomLine: "Bryggen for the photo. Fjellsiden for value and quiet.",
  },
  {
    slug: "nordnes-vs-fjellsiden",
    citySlug: "bergen", countrySlug: "norway",
    aSlug: "nordnes", bSlug: "bergenhus-fjellsiden",
    aLabel: "Nordnes", bLabel: "Fjellsiden",
    metaTitle: "Nordnes vs Fjellsiden: Where to Stay in Bergen",
    metaDescription: "Bergen's harbor peninsula Nordnes or hillside Fjellsiden? Real take on view, walkability and atmosphere.",
    intro: "Nordnes is the peninsula west of Bergen's centre — residential, harbor views, the Aquarium. Fjellsiden is the hillside east — wooden-house residential, Fløibanen base. Different sides of the city.",
    rounds: [
      { question: "Atmosphere", winner: "tied", body: "Both wooden-house residential. Nordnes is harbor-flat; Fjellsiden is hillside-steep." },
      { question: "Walkability to Bryggen", winner: "tied", body: "Both 10 min walk. Equivalent." },
      { question: "View", winner: "a", body: "Nordnes wins — harbor view from many hotel rooms." },
      { question: "Mobility", winner: "a", body: "Nordnes is flat. Fjellsiden is steep." },
      { question: "Price", winner: "tied", body: "Both €170-€280 for decent product. Equivalent." },
    ],
    pickA: "Pick Nordnes for harbor-view focus, mobility-aware travelers.",
    pickB: "Pick Fjellsiden for funicular access, photographers, anyone able to handle steep streets.",
    bottomLine: "Nordnes for view and walkability. Fjellsiden for funicular and photo.",
  },
  // GENEVA
  {
    slug: "eaux-vives-vs-carouge",
    citySlug: "geneva", countrySlug: "switzerland",
    aSlug: "eaux-vives", bSlug: "carouge",
    aLabel: "Eaux-Vives", bLabel: "Carouge",
    metaTitle: "Eaux-Vives vs Carouge: Where to Stay in Geneva",
    metaDescription: "Geneva's lake-side Eaux-Vives or Italianate Carouge? Real take on atmosphere, food and price.",
    intro: "Eaux-Vives is the left bank lakeside quarter — Jet d'Eau view, Parc La Grange. Carouge is south across the Arve — Italianate quarter built by Sardinians, dense restaurants, the calmer alternative.",
    rounds: [
      { question: "Lake access", winner: "a", body: "Eaux-Vives is at the lake. Carouge is 15-20 min from the lake." },
      { question: "Atmosphere", winner: "tied", body: "Eaux-Vives is polished-lakeside. Carouge is Italianate-residential. Different cities." },
      { question: "Restaurants past 10pm", winner: "b", body: "Carouge wins — denser independent restaurants. Eaux-Vives is more upscale-formal." },
      { question: "Walkability to centre", winner: "a", body: "Eaux-Vives is 10 min walk. Carouge needs tram or 30-min walk." },
      { question: "Price", winner: "b", body: "Carouge 15-20% cheaper than Eaux-Vives for equivalent product." },
    ],
    pickA: "Pick Eaux-Vives for first-time visits, lake-focused stays, business stays.",
    pickB: "Pick Carouge for food-focused trips, repeat visits, anyone wanting non-corporate Geneva.",
    bottomLine: "Eaux-Vives for lake. Carouge for food.",
  },
  {
    slug: "paquis-vs-carouge",
    citySlug: "geneva", countrySlug: "switzerland",
    aSlug: "paquis", bSlug: "carouge",
    aLabel: "Pâquis", bLabel: "Carouge",
    metaTitle: "Pâquis vs Carouge: Where to Stay in Geneva",
    metaDescription: "Geneva's gritty Pâquis or Italianate Carouge? Real take on atmosphere, food and price.",
    intro: "Both are non-Eaux-Vives Geneva alternatives. Pâquis is the right-bank quarter near the train station — multicultural, gritty in spots, dense food. Carouge is south of the Arve — Italianate-elegant.",
    rounds: [
      { question: "Atmosphere", winner: "tied", body: "Pâquis is multicultural-gritty. Carouge is Italianate-elegant. Different vibes." },
      { question: "Restaurants past 10pm", winner: "tied", body: "Both have density. Pâquis has multicultural variety; Carouge has Italianate quality." },
      { question: "Train station access", winner: "a", body: "Pâquis is at the train station. Carouge is 15-min tram ride." },
      { question: "Family-friendly", winner: "b", body: "Carouge wins — calmer, residential. Pâquis is for adults." },
      { question: "Price", winner: "tied", body: "Both 10-15% cheaper than Eaux-Vives. Equivalent to each other." },
    ],
    pickA: "Pick Pâquis for train-heavy itineraries, food-diversity focus, anyone under 40.",
    pickB: "Pick Carouge for families, longer stays, anyone over 40 wanting Italianate calm.",
    bottomLine: "Pâquis for train and grit. Carouge for families.",
  },
  // GOTHENBURG
  {
    slug: "vasastaden-gbg-vs-majorna",
    citySlug: "gothenburg", countrySlug: "sweden",
    aSlug: "vasastaden-gbg", bSlug: "majorna",
    aLabel: "Vasastaden", bLabel: "Majorna",
    metaTitle: "Vasastaden vs Majorna: Where to Stay in Gothenburg",
    metaDescription: "Gothenburg's central Vasastaden or creative Majorna? Real take on cafés, atmosphere and price.",
    intro: "Vasastaden is the central café-and-restaurant quarter just south of the historical centre. Majorna is west — formerly working-class, now creative-and-design quarter, dense neighborhood-cafés.",
    rounds: [
      { question: "Walkability to centre", winner: "a", body: "Vasastaden is 5-10 min walk. Majorna is 25-30 min by tram." },
      { question: "Atmosphere", winner: "tied", body: "Vasastaden is polished-café. Majorna is creative-lived-in. Different vibes." },
      { question: "Restaurants past 10pm", winner: "tied", body: "Both have density. Vasastaden is more polished; Majorna is more casual." },
      { question: "Price", winner: "b", body: "Majorna 20-25% cheaper than Vasastaden for equivalent product." },
      { question: "Family-friendly", winner: "a", body: "Vasastaden is more polished and central; Majorna is more bohemian." },
    ],
    pickA: "Pick Vasastaden for first-time visits, café-focused trips, families.",
    pickB: "Pick Majorna for repeat visits, creative-focused stays, budget-conscious longer stays.",
    bottomLine: "Vasastaden for first-timers. Majorna for value and creative.",
  },
  {
    slug: "linnestaden-vs-majorna",
    citySlug: "gothenburg", countrySlug: "sweden",
    aSlug: "linnestaden", bSlug: "majorna",
    aLabel: "Linnéstaden", bLabel: "Majorna",
    metaTitle: "Linnéstaden vs Majorna: Where to Stay in Gothenburg",
    metaDescription: "Gothenburg's Linnéstaden or Majorna? Real take on atmosphere, food and price.",
    intro: "Both are non-central Gothenburg alternatives. Linnéstaden is just west of central — dense café-and-restaurant strip, central walkability. Majorna is further west — creative-formerly-working-class.",
    rounds: [
      { question: "Walkability to centre", winner: "a", body: "Linnéstaden is 10-15 min walk. Majorna is 25-30 min tram." },
      { question: "Atmosphere", winner: "tied", body: "Linnéstaden is polished-residential. Majorna is creative-lived-in." },
      { question: "Restaurants past 10pm", winner: "a", body: "Linnéstaden has central-quality density. Majorna is more casual." },
      { question: "Price", winner: "b", body: "Majorna 15-20% cheaper than Linnéstaden for equivalent product." },
      { question: "Quiet sleep", winner: "tied", body: "Both quiet past 11pm. Equivalent." },
    ],
    pickA: "Pick Linnéstaden for food-focused trips, anyone over 35 wanting central proximity.",
    pickB: "Pick Majorna for repeat visits, creative-focused stays, budget-conscious longer stays.",
    bottomLine: "Linnéstaden for central proximity. Majorna for value.",
  },
  // MALMO
  {
    slug: "gamla-staden-malmo-vs-moller",
    citySlug: "malmo", countrySlug: "sweden",
    aSlug: "gamla-staden-malmo", bSlug: "moller",
    aLabel: "Gamla Staden", bLabel: "Möllevången",
    metaTitle: "Gamla Staden vs Möllevången: Where to Stay in Malmö",
    metaDescription: "Malmö's central old town or multicultural Möllevången? Real take on food, atmosphere and price.",
    intro: "Gamla Staden is Malmö's central old town — Lilla Torg, dense restaurants. Möllevången is south of central — the multicultural quarter, market and food density, the under-40 Malmö.",
    rounds: [
      { question: "Walkability to centre", winner: "a", body: "Gamla Staden is the centre. Möllevången is 10-15 min walk." },
      { question: "Restaurants past 10pm", winner: "tied", body: "Both excellent. Gamla Staden has Lilla Torg cluster. Möllevången has multicultural variety." },
      { question: "Atmosphere", winner: "tied", body: "Gamla Staden is medieval-tourist. Möllevången is multicultural-market. Pick on what you want." },
      { question: "Price", winner: "b", body: "Möllevången 15-20% cheaper than Gamla Staden for equivalent product." },
      { question: "Family-friendly", winner: "a", body: "Gamla Staden is more polished. Möllevången is gritty in spots." },
    ],
    pickA: "Pick Gamla Staden for first-time visits, families, anyone over 35.",
    pickB: "Pick Möllevången for food-diversity focus, anyone under 35, budget-conscious stays.",
    bottomLine: "Gamla Staden for first-timers. Möllevången for food and value.",
  },
  // ROTTERDAM
  {
    slug: "cool-district-vs-delfshaven",
    citySlug: "rotterdam", countrySlug: "netherlands",
    aSlug: "cool-district", bSlug: "delfshaven",
    aLabel: "Cool District", bLabel: "Delfshaven",
    metaTitle: "Cool District vs Delfshaven: Where to Stay in Rotterdam",
    metaDescription: "Rotterdam's central Cool District or historic Delfshaven? Real take on atmosphere, history and price.",
    intro: "Cool District is the central modern Rotterdam — Markthal, Erasmus Bridge nearby. Delfshaven is the historic harbor quarter west — narrow lanes, the Pilgrim Fathers' departure point, calmer.",
    rounds: [
      { question: "Atmosphere", winner: "tied", body: "Cool District is modern-architecture-central. Delfshaven is historic-harbor-residential. Different cities." },
      { question: "Walkability to Markthal", winner: "a", body: "Cool District is at the Markthal. Delfshaven is 25-30 min walk or 10 min tram." },
      { question: "Quiet sleep", winner: "b", body: "Delfshaven residential past 10pm. Cool District has central tourist noise." },
      { question: "History", winner: "b", body: "Delfshaven wins — survived WWII bombing, narrow lanes preserved." },
      { question: "Price", winner: "b", body: "Delfshaven 15-25% cheaper than Cool District for equivalent product." },
    ],
    pickA: "Pick Cool District for first-time visits, modern-architecture focus, sights at door.",
    pickB: "Pick Delfshaven for repeat visits, history-focused trips, longer stays.",
    bottomLine: "Cool District for first-timers. Delfshaven for history.",
  },
  // THE HAGUE
  {
    slug: "centrum-the-hague-vs-voorhout",
    citySlug: "the-hague", countrySlug: "netherlands",
    aSlug: "centrum-the-hague", bSlug: "voorhout",
    aLabel: "Centrum", bLabel: "Voorhout",
    metaTitle: "Centrum vs Voorhout: Where to Stay in The Hague",
    metaDescription: "The Hague's central Centrum or royal Voorhout? Real take on atmosphere, business and price.",
    intro: "Centrum is The Hague's central core — Binnenhof, dense restaurants. Voorhout is the leafy royal quarter east — Lange Voorhout palace, embassy quarter, dense diplomatic-restaurant cluster.",
    rounds: [
      { question: "Walkability to Binnenhof", winner: "tied", body: "Both 5-10 min walk. Equivalent." },
      { question: "Atmosphere", winner: "tied", body: "Centrum is central-tourist. Voorhout is wealthy-embassy. Different vibes." },
      { question: "Restaurants past 10pm", winner: "a", body: "Centrum has wider variety. Voorhout has higher-end diplomatic-restaurant cluster." },
      { question: "Quiet sleep", winner: "b", body: "Voorhout residential past 10pm. Centrum has central tourist noise." },
      { question: "Price", winner: "a", body: "Centrum 15-20% cheaper than Voorhout for equivalent product." },
    ],
    pickA: "Pick Centrum for first-time visits, restaurant-variety focus.",
    pickB: "Pick Voorhout for business stays, anyone over 50 wanting wealthy-embassy atmosphere.",
    bottomLine: "Centrum for first-timers. Voorhout for business.",
  },
  {
    slug: "scheveningen-vs-voorhout",
    citySlug: "the-hague", countrySlug: "netherlands",
    aSlug: "scheveningen", bSlug: "voorhout",
    aLabel: "Scheveningen", bLabel: "Voorhout",
    metaTitle: "Scheveningen vs Voorhout: Where to Stay in The Hague",
    metaDescription: "The Hague's beach Scheveningen or royal Voorhout? Real take on beach, families and price.",
    intro: "Scheveningen is the beach resort 5 km west of central — long sand beach, big resort hotels. Voorhout is the royal-and-embassy quarter east of Centrum — leafy residential, diplomatic-restaurant cluster.",
    rounds: [
      { question: "Beach access", winner: "a", body: "Scheveningen is at the beach. Voorhout is 20 min by tram." },
      { question: "Walkability to Binnenhof", winner: "b", body: "Voorhout is 5-10 min walk. Scheveningen is 20-25 min tram." },
      { question: "Atmosphere", winner: "tied", body: "Scheveningen is beach-resort. Voorhout is wealthy-embassy. Opposite trips." },
      { question: "Family-friendly", winner: "a", body: "Scheveningen wins — beach, pool resorts." },
      { question: "Restaurants past 10pm", winner: "b", body: "Voorhout has high-end diplomatic-restaurant cluster. Scheveningen has tourist-priced beach restaurants." },
    ],
    pickA: "Pick Scheveningen for beach-focused trips, families wanting hotel pools.",
    pickB: "Pick Voorhout for business stays, sights focus, anyone over 50.",
    bottomLine: "Scheveningen for beach. Voorhout for business.",
  },
  // THESSALONIKI
  {
    slug: "ladadika-vs-kalamaria",
    citySlug: "thessaloniki", countrySlug: "greece",
    aSlug: "ladadika", bSlug: "kalamaria",
    aLabel: "Ladadika", bLabel: "Kalamaria",
    metaTitle: "Ladadika vs Kalamaria: Where to Stay in Thessaloniki",
    metaDescription: "Thessaloniki's central Ladadika or seaside Kalamaria? Real take on atmosphere, food and walkability.",
    intro: "Ladadika is the central former-olive-oil-warehouse quarter — dense restaurants and bars, the city's evening centre. Kalamaria is east along the gulf — residential seaside, fish-tavernas, where wealthy Thessalonians live.",
    rounds: [
      { question: "Walkability to centre", winner: "a", body: "Ladadika is at the centre. Kalamaria is 20-25 min by bus or 8 min by Metro (when running)." },
      { question: "Restaurants past 10pm", winner: "tied", body: "Both excellent. Ladadika has central converted-warehouse cluster. Kalamaria has seafront fish-tavernas." },
      { question: "Atmosphere", winner: "tied", body: "Ladadika is converted-warehouse-tourist. Kalamaria is seaside-residential. Pick on side." },
      { question: "Price", winner: "b", body: "Kalamaria 15-25% cheaper than Ladadika for equivalent product." },
      { question: "Family-friendly", winner: "b", body: "Kalamaria wins — seaside walks, calmer streets." },
    ],
    pickA: "Pick Ladadika for first-time visits, food-focused short trips.",
    pickB: "Pick Kalamaria for families, longer stays, anyone wanting seaside residential.",
    bottomLine: "Ladadika for first-timers. Kalamaria for families.",
  },
  {
    slug: "ano-poli-vs-kalamaria",
    citySlug: "thessaloniki", countrySlug: "greece",
    aSlug: "ano-poli", bSlug: "kalamaria",
    aLabel: "Ano Poli", bLabel: "Kalamaria",
    metaTitle: "Ano Poli vs Kalamaria: Where to Stay in Thessaloniki",
    metaDescription: "Thessaloniki's hilltop Ano Poli or seaside Kalamaria? Real take on view, atmosphere and price.",
    intro: "Both are non-central Thessaloniki options. Ano Poli is the Upper Town on the hilltop — Byzantine walls, gulf views, atmospheric. Kalamaria is east along the gulf — residential seaside.",
    rounds: [
      { question: "Atmosphere", winner: "a", body: "Ano Poli wins on charm — Byzantine walls, narrow lanes, panoramic views over the gulf." },
      { question: "Walkability to centre", winner: "b", body: "Kalamaria is 20-25 min by bus. Ano Poli is 25-30 min walk steeply downhill (and uphill back)." },
      { question: "Mobility", winner: "b", body: "Kalamaria is flat. Ano Poli is brutally steep." },
      { question: "Family-friendly", winner: "b", body: "Kalamaria wins — seaside walks, flat streets, family-aware." },
      { question: "Price", winner: "tied", body: "Both 15-20% cheaper than central. Equivalent to each other." },
    ],
    pickA: "Pick Ano Poli for atmosphere-focused trips, photographers, repeat visits.",
    pickB: "Pick Kalamaria for families, longer stays, mobility-aware travelers.",
    bottomLine: "Ano Poli for the photo. Kalamaria for families.",
  },
);
